...
| 18 | [Perf/Network 采样数据持久化与导出](方案/18-Perf与Network采样数据持久化与导出.md) | ⏳ 调研 + 设计 v1.1（约 5.5-7 人日） |
...
**下一步**：Windows 绿色免安装 exe 打包（见 `方案/15`）；待排期：[Perf/Network 采样数据持久化与导出](方案/18-Perf与Network采样数据持久化与导出.md)
